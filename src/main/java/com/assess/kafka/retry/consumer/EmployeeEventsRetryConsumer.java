...
@Service
@Slf4j
public class EmployeeEventsRetryConsumer {

    @Value(value = "${spring.kafka.employee.bootstrap-servers:")
    private String bootstrapServer;
    @Value(value = "${spring.kafka.employee.consumer.group-id:")
    ...
    public ConcurrentKafkaListenerContainerFactory<String, EmployeeEvent> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, EmployeeEvent> concurrentKafkaListenerContainerFactory
